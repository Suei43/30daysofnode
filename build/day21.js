"use strict";
let buffer = Buffer.alloc(10); // To create a buffer
console.log(buffer);
let unsafebuffer = Buffer.allocUnsafe(10); // To create a unsafe buffer
console.log(unsafebuffer);
console.log(typeof buffer);
let bufferstr1 = Buffer.from('suei'); // To create a buffer from a string
let bufferstr2 = Buffer.from('suei');
...
let newbuffer = Buffer.alloc(20);
newbuffer.copy(buffer); // To copy one buffer to another
let newbuffer2 = Buffer.alloc(20);
newbuffer2 = buffer;
